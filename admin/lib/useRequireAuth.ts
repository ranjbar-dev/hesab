...
export type Admin={id:number;first_name:string;last_name:string;email:string;phone_number:string;is_male:boolean;two_fa_enabled:boolean;created_at:string;avatar_url:string|null};
